...
plt.subplot(1,1,1)
#The program won't let me use "add_subplot".
projection="3d"

constellation3d = (x, y, z)
plt.scatter(x, y, z)
#I'm not sure why, but when I try to scatter "constellation3d", it says that it's missing the argument for 'y'.
plt.show()

#The figure below shows a 2D illustraion but not 3d. Can you please review my work and let me know where I went wrong? Thank you in advance. 
